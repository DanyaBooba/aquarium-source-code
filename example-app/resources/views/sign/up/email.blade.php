...
@section('page.title', __('Регистрация в Аквариуме через почту и пароль'))
@section('page.ogtitle', __('Регистрация в Аквариуме через почту и пароль'))
@section('page.desc',
    __('Зарегистрируйтесь в Аквариуме с помощью почты и пароля. Создайте аккаунт и начните общение в
    социальной сети.'))
@section('page.ogdesc', __('Зарегистрируйтесь в Аквариуме с помощью почты и пароля. Создайте аккаунт и начните общение в
    социальной сети.'))
