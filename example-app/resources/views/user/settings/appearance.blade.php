...
@section('page.title', __('Настройки персонализации в Аквариуме — аватарка и шапка профиля'))
@section('page.ogtitle', __('Настройки персонализации в Аквариуме — аватарка и шапка профиля'))
@section('page.desc',
    __('Измените аватарку и шапку профиля в Аквариуме. Персонализируйте свой аккаунт и сделайте его
    особенным.'))
@section('page.ogdesc',
    __('Измените аватарку и шапку профиля в Аквариуме. Персонализируйте свой аккаунт и сделайте его
    особенным.'))
