...
<form action="" onsubmit="sendForm('{{ route('user.settings.index') }}')" method="post">
    ...
    <div class="input-group input-password" id="password-form1">
        <div>
            ...
            <input type="password" name="current_password" class="form-control" id="current_password" placeholder="{{ __('Пароль') }}" onInput="data()" required>
        </div>
    ...
    <div class="input-group input-password" id="password-form2">
        <div>
            ...
            <input type="password" name="new_password" class="form-control" id="new_password" placeholder="{{ __('Пароль') }}" onInput="data()" required>
        </div>
