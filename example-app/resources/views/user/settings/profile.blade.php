...
@section('page.title', __('Настройки профиля в Аквариуме — изменение личных данных'))
@section('page.ogtitle', __('Настройки профиля в Аквариуме — изменение личных данных'))
@section('page.desc',
    __('Измените личные данные, почту, пароль в Аквариуме. Управляйте настройками
    профиля легко и безопасно.'))
@section('page.ogdesc',
    __('Измените личные данные, почту, пароль в Аквариуме. Управляйте настройками
    профиля легко и безопасно.'))
