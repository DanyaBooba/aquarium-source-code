...
@section('page.title', __('Все настройки Аквариума — данные, кастомизация и темы'))
@section('page.ogtitle', __('Все настройки Аквариума — данные, кастомизация и темы'))
@section('page.desc',
    __('Управляйте всеми настройками аккаунта Аквариум. Измените данные профиля, кастомизируйте
    внешний вид и выберите тему системы.'))
@section('page.ogdesc',
    __('Управляйте всеми настройками аккаунта Аквариум. Измените данные профиля, кастомизируйте внешний вид
    и выберите тему системы.'))
...
@section('settings.content')
    <div class="container-settings-main">
        ...
        <x-settings.lists.list>
            ...
            {{-- <x-settings.lists.item route="{{ route('settings.session') }}" class="session" text="{{ __('Устройства') }}">
