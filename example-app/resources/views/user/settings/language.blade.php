...
@section('page.title', __('Настройки языка в Аквариуме'))
@section('page.ogtitle', __('Настройки языка в Аквариуме'))
@section('page.desc', __('Выберите язык интерфейса в Аквариуме. Настройте платформу для удобного использования на вашем
    языке.'))
@section('page.ogdesc', __('Выберите язык интерфейса в Аквариуме. Настройте платформу для удобного использования на
    вашем языке.'))
