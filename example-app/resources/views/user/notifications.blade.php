...
@section('page.desc', __('Проверьте уведомления о вашем профиле в Аквариуме. Получайте информацию об изменениях личных
    данных и входах в аккаунт.'))
@section('page.ogdesc', __('Проверьте уведомления о вашем профиле в Аквариуме. Получайте информацию об изменениях личных
    данных и входах в аккаунт.'))
