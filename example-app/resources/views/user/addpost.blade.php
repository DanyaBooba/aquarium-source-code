...
@section('page.desc', __('Создайте новую запись в Аквариуме. Делитесь своими мыслями, идеями и вдохновением с
    друзьями.'))
@section('page.ogdesc', __('Создайте новую запись в Аквариуме. Делитесь своими мыслями, идеями и вдохновением с
    друзьями.'))
