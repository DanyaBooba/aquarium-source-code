...
@section('main.content')
    <div class="row gx-3">
        ...
        <div class="col-7 p-3">
            ...
            <p>
                {{ __('При регистрации или изменении пароля, он хранится в зашифрованном виде, используя хэширование MD5 без возможности дешифрации. При несанкционированным доступе, получить пароль от аккаунта невозможно.') }}
            </p>
            ...
            <h3>Брендбук</h3>
            <p>
                Все принципы любых коммуникаций Аквариума, логотип Аквариума и дизайн-система. <a href="{{ route('main.brand') }}">Открыть</a>
            </p>
            ...
            <h2>Люди</h2>
            <p>
                Разработка социальной сети Аквариум отражает захватывающий и креативный процесс, способствующий созданию привлекательной онлайн-платформы. В этой работе принимают участие разные люди, каждому из которых мы хотим выразить личную благодарность:
            </p>
            <ul>
                <li>
                    Даниил Дыбка – разработчик проекта, автор,
                    <a href="//ddybka.t.me">@@ddybka</a>
                </li>
                <li>
                    Анастасия Пара – художник, автор стикеров,
                    <a href="//paraananas.t.me">@@paraananas</a>
                </li>
                <li>
                    Роман Казин – художник, автор шапок,
