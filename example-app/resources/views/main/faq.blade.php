    ...
    <div class="row gx-3">
        ...
        <div class="col-7 p-3">
            ...
            <ul>
                ...
                <li class="mb-2">
                    <span class="border border-1 rounded-2 m-1 p-1 ms-0">{{ __('Общественные личности') }}</span> Те, кто стремится к объединению общественных усилий, обсуждению проблем и поиску партнеров
                </li>
                <li class="mb-2">
