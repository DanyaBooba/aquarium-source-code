...
@section('page.desc',
    __('Официальная страница Аквариума для СМИ. Основная информация, тексты, материалы и медиа-ресурсы
    о проекте.'))
@section('page.ogdesc',
    __('Официальная страница Аквариума для СМИ. Основная информация, тексты, материалы и
