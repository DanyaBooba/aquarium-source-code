...
@section('page.ogtitle', __('Политика обработки файлов cookie'))
@section('page.desc', __('Ознакомьтесь с политикой обработки файлов cookie в Аквариуме. Узнайте, как мы используем
    cookie для улучшения работы платформы.'))
@section('page.ogdesc', __('Ознакомьтесь с политикой обработки файлов cookie в Аквариуме. Узнайте, как мы используем
    cookie для улучшения работы платформы.'))
    ...
    <div class="row gx-3">
        ...
        <div class="col-7 p-3">
            ...
            <ul>
                ...
                <li>{{ __('усовершенствования продуктов и (или) услуг и для разработки новых продуктов и (или) услуг.') }}
                </li>
            </ul>
            <p>
