...
<div style="margin-top: 5rem">
    ...
    <div style="margin-top: 1rem">
        <h3 class="d-flex flex-wrap">
            ...
            <span class="container-simple-numbers-text">человек зарегистрировано</span>
        </h3>
    </div>
    <div style="margin-top: 1rem">
        <h3 class="d-flex flex-wrap">
            ...
            <span class="container-simple-numbers-text">раз заходили в соцсеть</span>
        </h3>
    </div>
    <div style="margin-top: 1rem">
        <h3 class="d-flex flex-wrap">
            ...
            <span class="container-simple-numbers-text">пользователей подтвердили почту</span>
        </h3>
    </div>
</div>
<div style="margin-top: 5rem">
