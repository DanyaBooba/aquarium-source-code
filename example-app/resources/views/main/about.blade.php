...
<body class="container">
    <main class="col-md-8 mx-auto" style="margin-bottom: 50px" id="main">
        ...
        <div class="row row-cols-1 row-cols-lg-2 g-2 fs-5" style="margin-bottom: 100px">
            <div class="col p-3">
                <p>
                    На нашей платформе зарегистрировано <span class="text-success fs-4" id="anim1">20</span> 20,
                    из которых <span class="text-success fs-4">20%</span> имеют подтвержденные аккаунты.
                </p>
