...
@section('page.desc', __('Аквариум — социальная сеть для самовыражения и общения'))
@section('page.ogdesc', __('Аквариум — социальная сеть для самовыражения и общения'))

<meta name="description"
    content="Аквариум — уникальная социальная сеть с кастомизацией профиля, записями и цветовыми темами. Присоединяйтесь и создайте свой мир!">
<meta name="keywords"
    content="социальная сеть Аквариум, кастомизация профиля, цветовые темы, записи, самовыражение, онлайн-сообщество, персонализация, креативность, блоги, общение">
