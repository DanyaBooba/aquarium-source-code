...
imagettftext($image, 40, 0, $avatarX + $avatarSize + 20, $avatarY + 50, $textColor, $fontTitle, $name);
imagettftext($image, 20, 0, $avatarX + $avatarSize + 20, $avatarY + 90, $textColor, $fontText, $description);

// Добавляем блок с подписчиками, подписками и достижениями
$blockY = $avatarY + $avatarSize + 50;
$blockX = $avatarX;
$blockSpacing = 200;
